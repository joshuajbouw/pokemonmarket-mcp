...
- [x] Test: Card with low inventory (< 20) returns 70% offer
- [x] Test: Card with high inventory (>= 20) returns "not buying"
- [x] Test: Submit to buy list creates pending request
- [x] Test: Check status returns correct state
- [x] Test: Invalid product/variant returns error
- [x] Test: Exact price calculations (no approximations)
