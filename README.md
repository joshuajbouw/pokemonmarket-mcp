# Runic Vault MCP Server

A TypeScript MCP (Model Context Protocol) server for [Runic Vault](https://runic-vault.ae) - AI-assisted e-commerce with real Unicity token payments.
